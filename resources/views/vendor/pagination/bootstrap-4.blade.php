    ...
    <ul class="pagination flex list-reset border border-grey-light rounded w-auto font-sans bg-white" role="navigation" style="margin: 0 auto;">
        ...
        @if ($paginator->onFirstPage())
            <li class="disabled" aria-disabled="true" aria-label="@lang('pagination.previous')">
                <span aria-hidden="true" class="block border-r border-grey-light px-3 py-2" style="cursor: not-allowed">&lsaquo;</span>
            </li>
        @else
            <li>
        ...
        @else
            <li class="disabled" aria-disabled="true" aria-label="@lang('pagination.next')">
                <span aria-hidden="true" class="block border-r border-grey-light px-3 py-2" style="cursor: not-allowed">&rsaquo;</span>
            </li>
        @endif
    </ul>
@endif
